...
class HomeViewController: UIViewController {
    ...
    private func setupMainPlacesViews() {
        for mainPlace in mainPlaces {
            ...
            NSLayoutConstraint.activate([
                mainPlaceView.widthAnchor.constraint(equalToConstant: 200), // Adjust width as needed
    ...
    private func setupRecommendedTrips() {
        ...
        NSLayoutConstraint.activate([
            ...
            recommendedTripsScrollView.heightAnchor.constraint(equalToConstant: 300),
            ...
            recommendedTripsContentView.bottomAnchor.constraint(equalTo: recommendedTripsScrollView.bottomAnchor),
